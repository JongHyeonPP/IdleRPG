                ...
                switch (_scrollView.mode)
                {
                    case ScrollViewMode.Vertical:
                        ...
                        newScrollOffset.y = Mathf.Clamp(
                            newScrollOffset.y,
                            0,
                            Mathf.Max(0, _scrollView.contentContainer.resolvedStyle.height - _scrollView.resolvedStyle.height)
                        );
                        break;
                    ...
                    case ScrollViewMode.Horizontal:
                        ...
                        newScrollOffset.x = Mathf.Clamp(
                            newScrollOffset.x,
                            0,
                            Mathf.Max(0, _scrollView.contentContainer.resolvedStyle.width - _scrollView.resolvedStyle.width)
                        );
                        break;
