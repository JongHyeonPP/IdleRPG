...
public class StageInfo : ScriptableObject, IListViewItem
{
    ...
    [Header("Drop Info")]
    [HideInInspector] public float goldBonusValue;    // Remote Config에서 runtime 할당
    [HideInInspector] public float expBonusValue;     // Remote Config에서 runtime 할당
    [HideInInspector] public (Rarity rarity, int count)? fragmentDropInfo;
    [HideInInspector] public string weaponDropId; // null이면 무기 드롭 없음
