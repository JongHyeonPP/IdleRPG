...
namespace Kamgam.UIToolkitBlurredBackground
{
    ...
    public class BlurManager
    {
        ...
        static void ResetOnPlayModeEnter()
        {
            if (_instance != null)
            {
                if (_instance._renderer != null)
                    _instance._renderer.Active = false;
                _instance = null;
            }
        ...
        public List<VisualElement> BlurredBackgroundElements => _blurredBackgroundElements;
        ...
        {
            // Count the visible elements (display: none, visibility: hidden are not counted)
