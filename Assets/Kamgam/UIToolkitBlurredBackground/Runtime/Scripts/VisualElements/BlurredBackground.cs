    ...
    public partial class BlurredBackground : VisualElement
    {
        ...
        public Vector2Int BlurResolutionSize
        {
            ...
            set
            {
                ...
                if (BlurManager.Instance.Resolution != value)
                {
        ...
        protected virtual void onGeometryChanged(GeometryChangedEvent evt)
        {
            ...
            if (!m_lastIsDrawnValue.HasValue || m_lastIsDrawnValue.Value != isDrawn)
            {
                ...
                if (isDrawn)
                {
                    ...
                    BlurManager.Instance.Quality = BlurQuality;
                    BlurManager.Instance.Iterations = BlurIterations;
                    BlurManager.Instance.Offset = BlurStrength;
                    BlurManager.Instance.Resolution = BlurResolutionSize;
                ...
                else
                {
                    ...
                    if (ActiveBackgrounds.Count > 0)
                    {
                        ...
                        BlurManager.Instance.Quality = last.BlurQuality;
                        BlurManager.Instance.Iterations = last.BlurIterations;
                        BlurManager.Instance.Offset = last.BlurStrength;
                        BlurManager.Instance.Resolution = last.BlurResolutionSize;
                    }
                }
            }
        }
